...
gulp.task('develop', function(callback) {
	plugins.runSequence('sprite-create', 'sass-develop', 'babelify-develop', 'browser-sync', callback);
});

gulp.task('build', function(callback) {
	plugins.runSequence('sprite-create', 'svg2png', 'svgo-sprite', 'sass-build', 'babelify-build', callback);
});
